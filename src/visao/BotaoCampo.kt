...
//definindo cores dos eventos do campo
private val COR_BG_NORMAL = Color(187,184,184)
...
//tornando um campo em um botão e acionando o listener a ele
class BotaoCampo(private val campo: Campo) : JButton(){
    init {
        ...
        campo.onEvento(this::aplicarEstilo)// sempre que um evento acontecer será chamado o método onEvento, aplicando o estilo no campo
    }
    ...
    private fun aplicarEstilo(campo: Campo, evento: CampoEvento){
        ...
        SwingUtilities.invokeLater { //método assíncrono para validar as mudanças no campo
            repaint()
            validate()
        }
    }
